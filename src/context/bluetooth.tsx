...
interface BluetoothContextProps {
    ...
    connectedDevice: Peripheral |  any;
    notifications: { [key: string]: string }; // Characteristic UUIDs mapped to data
  }


  const defaultValue: BluetoothContextProps = {
  ...
  const BlueContext = createContext<BluetoothContextProps>(defaultValue);


export const BlueProvider = ({ children }: {
